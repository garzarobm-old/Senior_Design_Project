...
//hw
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/app_main.h"
//hci
...
#include "calc128.h" //what is this? <-- miguel comment
#include "dm_api.h"
#include "att_api.h"
#include "svc_core.h"
#include "app_api.h"
...
void AppSlaveProcDmMsg(dmEvt_t *pMsg)
{
  appConnCb_t *pCb = NULL;
   ...
   am_util_stdio_printf("AppSlaveProcDmMsg() ---> ,\r\n");    //debug
  /* look up app connection control block from DM connection ID */
  ...
  switch (pMsg->hdr.event)
  {
    ...
    case DM_HW_ERROR_IND:
   		am_util_stdio_printf("HciDrvRadioBoot(0) was called ,\r\n");    //debug
      HciDrvRadioBoot(0);
      DmDevReset();
      break;
