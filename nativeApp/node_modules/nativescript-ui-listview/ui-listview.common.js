...
var ListViewEventData = /** @class */ (function () {
    ...
    Object.defineProperty(ListViewEventData.prototype, "dataItemIndex", {
        get: function () {
...
var RadListView = /** @class */ (function (_super) {
    ...
    RadListView.prototype.logWarningIfNeeded = function () {
        if (this.parent instanceof stack_layout_1.StackLayout || this.parent instanceof scroll_view_1.ScrollView) {
    ...
    RadListView.prototype.onItemSelectedBackgroundColorPropertyChanged = function (oldValue, newValue) {
    ...
    RadListView.prototype.onItemSelectedBackgroundColorChanged = function (oldValue, newValue) {
    };
    ...
    RadListView.itemSelectedBackgroundColorProperty = new view_1.Property({
