...
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/hrps_api.h"
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/rscp_api.h"
...
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/svc_core.h"
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/svc_hrs.h"
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/svc_dis.h"
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/svc_batt.h"
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/svc_rscs.h"
...
#include "tensorflow/lite/micro/examples/micro_speech/sparkfun_edge/seniorFitSrc/exactle/include/app_db.h"
...
{
  5000 /*! Measurement timer expiration period in ms */
};
...
static const uint8_t fitAdvDataDisc[] =
{
  ...
  UINT16_TO_BYTES(0x180D),
  UINT16_TO_BYTES(0x1814),
  UINT16_TO_BYTES(0x180A),
  UINT16_TO_BYTES(0X180F)
};
  ...
  switch(pMsg->hdr.event)
  {
    ...
    case DM_ADV_START_IND:
      uiEvent = APP_UI_ADV_START;
  	  am_util_stdio_printf("DM_ADV_START_IND -->\r\n");//miguel call 2
      break;
...
void FitHandlerInit(wsfHandlerId_t handlerId)
{
  ...
  am_util_stdio_printf("hrpsInit --> battery initialize\r\n");//miguel call 2
  ...
  am_util_stdio_printf("basInit --> battery initialized\r\n");//miguel call 2
