...
var Frame = (function (_super) {
    ...
    Frame.prototype._processNextNavigationEntry = function () {
        ...
        var isNewEntry = !this._cachedTransitionState || entry !== this._cachedTransitionState.entry;
    ...
    Frame.prototype.setCurrent = function (entry, navigationType) {
        ...
        if (navigationType === frame_common_1.NavigationType.replace) {
            ...
            fragment_transitions_1._setAndroidFragmentTransitions(animated, navigationTransition, currentEntry, newEntry, this._android.frameId, transaction);
        }
    };
    ...
    Frame.prototype._navigateCore = function (newEntry) {
        ...
        fragment_transitions_1._setAndroidFragmentTransitions(animated, navigationTransition, currentEntry, newEntry, this._android.frameId, transaction, isNestedDefaultTransition);
    ...
    Frame.prototype._goBackCore = function (backstackEntry) {
        ...
        fragment_transitions_1._reverseTransitions(backstackEntry, this._currentEntry);
...
function cloneExpandedTransitionListener(expandedTransitionListener) {
    ...
    return fragment_transitions_1.addNativeTransitionListener(expandedTransitionListener.entry, cloneTransition);
}
...
var FragmentCallbacksImplementation = (function () {
    ...
    FragmentCallbacksImplementation.prototype.onDestroyView = function (fragment, superFunc) {
        ...
        if (hasRemovingParent) {
            var bitmapDrawable = new android.graphics.drawable.BitmapDrawable(application.android.context.getResources(), this.backgroundBitmap);
    ...
    FragmentCallbacksImplementation.prototype.onPause = function (fragment, superFunc) {
        var hasRemovingParent = fragment.getRemovingParentFragment();
        if (hasRemovingParent) {
    ...
    FragmentCallbacksImplementation.prototype.loadBitmapFromView = function (view) {
...
var ActivityCallbacksImplementation = (function () {
    ...
    ActivityCallbacksImplementation.prototype.setActivityContent = function (activity, savedInstanceState, fireLaunchEvent) {
        ...
        if (!rootView) {
            ...
            system_classes_1.pushToRootViewCssClasses("" + system_classes_1.CLASS_PREFIX + application.android.systemAppearance);
